...
count_vector = pk.load(open(r'count_vectorizer.pkl','rb'))            # Count Vectorizer
tfidf_transformer = pk.load(open(r'tfidf_transformer.pkl','rb')) # TFIDF Transformer

model = pk.load(open(r'logReg_hypar.pkl','rb'))     # Classification Model
#recommend_matrix = pk.load(open('user_final_rating.pkl','rb'))   # User-User Recommendation System 
with open(r'user_final_rating.pkl', 'rb') as file:
